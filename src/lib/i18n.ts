...
export const translations: Record<Lang, Record<string, string>> = {
  ...
  en: {
    ...
    'research.sub': 'Tech trends, industry observations, and reflections.',
    'research.count': 'posts',
    'engineering.eyebrow': '/engineering',
